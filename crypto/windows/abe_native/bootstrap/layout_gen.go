...
const (
	...
	ParamsSize          = C.BOOTSTRAP_PARAMS_SIZE
	ParamScratchBase    = C.BOOTSTRAP_PARAM_SCRATCH_BASE
	ParamLoadLibraryA   = C.BOOTSTRAP_PARAM_LOAD_LIBRARY_A
	ParamGetProcAddress = C.BOOTSTRAP_PARAM_GET_PROC_ADDRESS
	ParamVirtualAlloc   = C.BOOTSTRAP_PARAM_VIRTUAL_ALLOC
	ParamVirtualProtect = C.BOOTSTRAP_PARAM_VIRTUAL_PROTECT
	ParamNtFlushIC      = C.BOOTSTRAP_PARAM_NT_FLUSH_IC
